...
export const jobSchema = z.object({
  ...
  location: z.string().min(1, "Please select locaion"),
  ...
  companyLogo: z.string().min(10, "Company Logo is required"),
  companyWebsite: z.string().min(10, "Company Website is required"),
